...
btn1.addEventListener('click', () =>{ //esse meu btn recebe um evento click que ao ser clicado vai executar uma função
    let input_senha = document.querySelector ('#v_senha') //essa função vai criar uma variável input_senha e vai pegar o id senha do input 
...
btn2.addEventListener('click', () =>{ //esse meu btn recebe um evento click que ao ser clicado vai executar uma função
    let input_senha = document.querySelector ('#v_conf_senha') //essa função vai criar uma variável input_senha e vai pegar o id senha do input 
